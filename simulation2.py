#####################
## Example from Ricky Nguyn for study purposes.
## used lamda
## this version runs, and ends properly, and works fine with the rest of the code. 
## original code runs infinitely
## original disease does not spread, but comparitors work
#####################
